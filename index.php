        ...
        <ol>
            ...
            La società consociata Google che offre i servizi, tratta le tue informazioni ed è responsabile del rispetto delle leggi sulla privacy vigenti. Generalmente Google offre i propri servizi per i consumatori tramite una delle due società seguenti:
                <ol class='second'>
                    ...
                    <li>Google LLC, con sede negli Stati Uniti, per il resto del mondo.<7li>
                </ol>
            </li>
...
<body>
        ...
        <nav>
            ...
            <div class="">
                <ul class="d-flex">
                    ...
                    <li class="fw-bold">Termini di servizio</li>
                    <li class="fw-bold">Tecnologie</li>
                    <li class="fw-bold"><a href='#'>Domande frequenti</a></li>
                </ul>
            </div>
        </nav>
    </header>
    ...
    <div class="container">
        ...
        <li>
            <?php echo "{$faq[$i]['domanda']}<br> {$faq[$i]['risposta']} "; ?> 
        </li>
            <?php } ?> 
        </ul>
    </div>
    ...
    <footer>
        <div class="container d-flex justify-content-between">
            <ul class="d-flex">
                <li class="clr">Google</li>
                <li class="clr">Tutto su Google</li>
                <li class="clr">Privacy</li>
                <li class="clr">Termini</li>
            </ul>
            <div>
